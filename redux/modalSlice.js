...
const modalSlice = createSlice({
  ...
  reducers: {
    ...
    setCommentTweetDetails: (state, action) => {
...
export const { openLoginModal, setCommentTweetDetails, closeSignupModal, openSignupModal, closeLoginModal, openCommentModal, closeCommentModal} = modalSlice.actions
